...
Gama::Gama(sf::Texture * t,std::string ty,float time):Invaders(t,ty,time){
}
void Gama::attack(float &timer,Bomb**&bo,int &num_bombs,sf::Texture &en_bomb,Enemy**&enemy,int ind){
